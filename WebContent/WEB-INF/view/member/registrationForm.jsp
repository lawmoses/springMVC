...
<form method="post">
	...
	<form:errors path="memberInfo.password"/> 
	<br/>
	
	<label for="password">확인</label>
	<input type="password" name="cofirmPassword" id="confirmPassword" value="${memberInfo.confirmPassword }" />
	<form:errors path="memberInfo.confirmPassword"></form:errors>
	<br/>
	
	<label>주소</label>
	주소1
	<input type="text" name="address.address1" value="${memberInfo.address.address1}" />
	<form:errors path="memberInfo.address.address1"></form:errors>
	<br/>
	<br/>
	주소2
	<input type="text" name="address.address2" value="${memberInfo.address.address2}" />
	<form:errors path="memberInfo.address.address2"></form:errors>
	<br/>
	<br/>
	우편번호
	<input type="text" name="address.zipcode" value="${memberInfo.address.zipcode}" />
	<form:errors path="memberInfo.address.zipcode"></form:errors>
	<br/>
	<br/>
