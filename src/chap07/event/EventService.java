...
public class EventService {
	...
	public EventService () {
		...
		eventMap.put(3L, Event.create(3L, "강남 스타일 플래시 몹", EventType.CONFERENCE));
		eventMap.put(4L, Event.create(4L, "태극 플레시 몹", EventType.CONFERENCE));
